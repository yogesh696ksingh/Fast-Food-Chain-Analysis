...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 2em">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="/restaurantDashboard">Food Chain Dashboard</a>
        </li>
</nav>
<div class="container">
    <hr>
    <div class="row">
        <div class="col-sm-6 offset-4">
            <form method="POST" action="/viewRestaurantData" class="form-inline" name="restaurantSelectForm">
    ...
    <div>
        <p class="lead"><small class="text-muted">Most Popular </small> {{ $mostpos }} </p>
    </div>
    <div>
        <p class="lead">Popularity Chart</p>
